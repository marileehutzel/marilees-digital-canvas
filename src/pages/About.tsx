      ...
      <section className="container mx-auto px-6 pt-32 pb-20">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-6 text-lg text-foreground/80 animate-fade-in" style={{ animationDelay: "0.2s" }}>
            <p>
              I'm a UX/UI Designer passionate about creating intuitive, data-driven
              experiences that solve complex business challenges. With expertise in
              enterprise software design, I specialize in transforming intricate
              data sets and workflows into elegant, user-friendly interfaces.
            </p>
            
            <p>
              My work spans across various domains including financial compliance,
              machine learning interfaces, data visualization, and design systems.
              I believe in the power of thoughtful design to bridge the gap between
            ...
            <div className="pt-8">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="p-4 bg-card rounded-lg shadow-card">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Complex data storytelling and dashboard design
                  </p>
                </div>
                <div className="p-4 bg-card rounded-lg shadow-card">
                  <h3 className="font-semibold text-foreground mb-2">Design Systems</h3>
                  <p className="text-sm text-muted-foreground">
                    Component libraries and design token management
                  </p>
                </div>
                <div className="p-4 bg-card rounded-lg shadow-card">
                  <h3 className="font-semibold text-foreground mb-2">Enterprise Software</h3>
                  <p className="text-sm text-muted-foreground">
                    B2B SaaS and complex workflow optimization
                  </p>
                </div>
              </div>
            </div>
