      ...
      <div className="space-y-32 animate-fade-in">
        <section>
          ...
          <p>
            ...
            into wireframes, prototypes, and refined UI designs. I also collaborated closely with iOS/Android developers
            and backend engineers to ensure seamless implementation aligned with the existing desktop design system.
          </p>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            customer issues. We needed to create a mobile experience that maintained the power of the desktop platform
            while optimizing for smaller screens and on-the-go usage patterns.
          </p>
        </section>
        ...
        <section className="space-y-8">
          ...
          <p className="mb-6">
            ...
            could complete in seconds, even with poor connectivity.
          </p>
        ...
        <section className="space-y-8">
          ...
          <p className="mb-6">
            ...
            turnaround time for support and improving data quality from the field.
          </p>
        ...
        <section>
          ...
          <div className="space-y-6">
            <div className="p-6 bg-card rounded-lg shadow-card hover:shadow-elegant transition-all duration-300">
              ...
              <p>
                Push notifications and in-app alerts keep teams informed of critical customer experience events as they
                happen.
              </p>
            </div>
            <div className="p-6 bg-card rounded-lg shadow-card hover:shadow-elegant transition-all duration-300">
              <h3 className="mb-3">Mobile Dashboards</h3>
              <p>
                Optimized data visualizations that maintain clarity on smaller screens with touch-friendly drill-down
                capabilities.
              </p>
            </div>
            <div className="p-6 bg-card rounded-lg shadow-card hover:shadow-elegant transition-all duration-300">
              <h3 className="mb-3">Field Feedback System</h3>
              <p>
                Quick-capture forms with photo/video support for field agents to submit customer insights and issues
                instantly.
              </p>
            </div>
          </div>
        ...
        <section>
          ...
          <div className="grid md:grid-cols-3 gap-8 text-center">
            <div className="p-6">
              ...
              <p>User adoption within first month</p>
            </div>
            <div className="p-6">
              <div className="text-4xl font-bold text-primary mb-2">50%</div>
              <p>Faster response to field issues</p>
            </div>
            <div className="p-6">
              <div className="text-4xl font-bold text-primary mb-2">3x</div>
              <p>Increase in field feedback submissions</p>
            </div>
          </div>
        </section>
        ...
        <section>
          ...
          <p>
            ...
            that text alone couldn't convey.
          </p>
        </section>
      </div>
    </CaseStudyLayout>
