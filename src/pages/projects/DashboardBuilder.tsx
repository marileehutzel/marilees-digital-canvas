    ...
    >
      <div className="space-y-32 animate-fade-in">
        <section>
          ...
          <p>
            The internal business analyst received feedback from clients that led to filling requests with developers
            for every new view. This was creating a considerable bottleneck and using developer's time unwisely.
            Feedback from clients was frank and honest. They felt we were lagging behind competitors that offered
            customization and were at a crossroads for jumping to another product. We needed a way for users that was:
            simple enough for first-time users, robust enough for client analysts, consistent with our new design
