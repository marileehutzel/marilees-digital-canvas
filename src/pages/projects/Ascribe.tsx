  ...
  return (
    ...
    >
      <div className="space-y-32">
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Theme Extractor - AI-Powered Analysis</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Ask Ascribe - Conversational Data Analysis</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Sentiment Analysis & Visualization</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">X-Score Satisfaction Metric</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Interactive Data Exploration</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Multi-Lingual Capabilities</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Theme Clustering & Pattern Recognition</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Analysis Dashboard</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Trend Analysis & Time Comparisons</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Generative AI Configuration</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Enterprise-Scale Processing</h4>
          <p>
        ...
        <section className="space-y-8">
          <h4 className="mb-6">Voxco Platform Integration</h4>
          <p>
        ...
        <section className="animate-fade-in">
          <h4 className="mb-6">Platform Impact</h4>
