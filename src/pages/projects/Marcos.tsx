...
const imgClass = "w-1/2 h-auto mx-auto rounded-lg shadow-elegant";
    ...
    >
      <div className="space-y-32 animate-fade-in">
        <section className="space-y-8">
          ...
          <LightboxImage src={image1} alt="Pizza builder initial wireframes" className={imgClass} />
        ...
        <section className="space-y-8">
          ...
          <LightboxImage src={image2} alt="Adding extra or light topping amount sketch" className={imgClass} />
        </section>
        ...
        <section className="space-y-8">
          ...
          <div className="space-y-6">
            <LightboxImage src={image3} alt="Topping selection interface" className={imgClass} />
            <LightboxImage src={image4} alt="Topping customization options" className={imgClass} />
          </div>
        </section>
