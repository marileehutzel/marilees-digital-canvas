    ...
    >
      <div className="space-y-32">
        <section className="space-y-8 animate-fade-in">
          <h4 className="mb-6">Internal Business Stakeholder Idea</h4>
        ...
        <section className="animate-fade-in -mx-6 md:-mx-12 lg:-mx-[calc((100vw-1024px)/2)] px-6 md:px-12 lg:px-[calc((100vw-1024px)/2)] py-16 bg-muted/100">
          <div className="max-w-7xl mx-auto space-y-8">
            <h4 className="mb-6">No Skipping Steps</h4>
            <p className="max-w-4xl">
        ...
        <section className="animate-fade-in">
          <div className="grid md:grid-cols-2 gap-12 items-center">
            <div className="space-y-6">
              <h4 className="mb-6">Personas & User Journeys</h4>
              <p>
        ...
        <section className="space-y-8 animate-fade-in">
          <h4 className="mb-6">Competitor Analysis</h4>
          <p className="max-w-4xl">
        ...
        <section className="space-y-8 animate-fade-in">
          <h4 className="mb-6">FigJam Wireframes</h4>
          <p className="max-w-4xl">
