    ...
    >
      <div className="space-y-32">
        <section className="space-y-8 animate-fade-in">
          <h2>Initial Concepts & Sketches</h2>
          <p className="max-w-4xl">
            Early ideation phase exploring app structure, loyalty program integration, and custom iconography.
          </p>
          <img src={image1} alt="Initial concept sketches" className="w-full rounded-lg shadow-elegant" />
        </section>

        <section className="space-y-8 animate-fade-in">
          <h2>Loyalty Program Architecture</h2>
          <p className="max-w-4xl">
            Detailed exploration of the loyalty program flow, rewards structure, and user journey mapping.
          </p>
          <img src={image2} alt="Loyalty program wireframes" className="w-full rounded-lg shadow-elegant" />
        </section>
        ...
        <section className="animate-fade-in -mx-6 md:-mx-12 lg:-mx-[calc((100vw-1024px)/2)] px-6 md:px-12 lg:px-[calc((100vw-1024px)/2)] py-16 bg-muted/100">
          <div className="max-w-7xl mx-auto space-y-8">
            <h2>Custom Icon Set Design</h2>
            <p className="max-w-4xl">
              Development of a comprehensive custom icon set that aligns with McAlister's Deli brand identity.
            </p>
            <img src={image3} alt="Custom icon set" className="w-full rounded-lg shadow-elegant" />
          </div>
        </section>

        <section className="space-y-8 animate-fade-in">
          <h2>Menu & Ordering Interface</h2>
          <p className="max-w-4xl">
            Designing an intuitive ordering interface that integrates seamlessly with the loyalty program.
          </p>
          <img src={image4} alt="Menu and ordering interface" className="w-full rounded-lg shadow-elegant" />
        </section>

        <section className="space-y-8 animate-fade-in">
          <h2>User Flow Refinement</h2>
          <p className="max-w-4xl">
            Iterative refinement of user flows to ensure smooth navigation between features.
          </p>
          <img src={image5} alt="User flow diagrams" className="w-full rounded-lg shadow-elegant" />
        </section>

        <section className="space-y-8 animate-fade-in">
          <h2>Final Design Concepts</h2>
          <p className="max-w-4xl">
            Polished design concepts bringing together the loyalty experience and custom iconography.
          </p>
          <img src={image6} alt="Final design concepts" className="w-full rounded-lg shadow-elegant" />
        </section>
