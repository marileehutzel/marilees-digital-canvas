...
const ProjectCard = ({ title, image, link, description, imageClassName }: ProjectCardProps) => {
    ...
    <>
      <div className="aspect-square overflow-hidden max-w-[280px] mx-auto rounded-lg relative">
        <img
          ...
          className={
            imageClassName ||
            "w-full h-full object-cover scale-125 transition-transform duration-700 group-hover:scale-110"
          }
        />
  ...
  const commonClasses = "group block relative overflow-hidden hover:scale-[1.02]";
